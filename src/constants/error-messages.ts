...
export const firstNameOrSurnameRegexErrorMsg =
  "Must contain only letters, spaces, hyphens, or diacritic characters";
...
export const addressLine1Max128ErrorMsg =
  "Address must be less than 128 characters";
export const cityRequiredErrorMsg = "City field is required";
export const cityStateRegexErrorMsg =
...
export const zipCodeRegexErrorMsg =
  "Must be 5 or 9 digits. e.g.25256, 25256-2589";
