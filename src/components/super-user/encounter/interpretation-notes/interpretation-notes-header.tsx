...
const InterpretationNotesHeader = () => {
      ...
      <Grid container width={"45%"} columnGap={3} rowGap={1}>
        ...
        <Grid container flexDirection={"column"} rowGap={1.5}>
          <Grid>
            ...
            <br />
            <Typography variant="bodySmall">martine.sh@example.com</Typography>
          </Grid>
          <Grid container flexDirection={"column"} rowSpacing={1}>
            ...
            >
              <Grid container columnSpacing={1}>
                <CakeOutlinedIcon sx={{ fontSize: "18px", color: "#595F63" }} />
                <Typography
                  color="#595F63"
...
export default InterpretationNotesHeader;
